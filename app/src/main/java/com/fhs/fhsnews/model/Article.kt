...
data class Article(
	...
	var timeUntil: Date = Date(0), // (Optional) Time of when the associated activity will happen (Set to 0 to skip. If specified, the timestamp will show how long until that activity happens i.e. "In 4 days" instead of "6 hours ago", as well as placing the article on the calendar at that date) TODO: Implementation
