...
data class Article(
    ...
    var articleId: Int, // Id of this article. Can be any int as long as no articles share the same ID
    ...
    var subtitle: String, // (Optional) Subtitle displayed below the headline
